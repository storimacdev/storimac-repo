# P1-Prompt1-STORY DEVELOPMENT INTERVIEW SYSTEM (v1.3)
...
1. **NARRATIVE OPERATING PRINCIPLES**
...
1. **STRICT SCOPE BOUNDARIES & DEFERRALS**
...
1. **CANON & DECISION STATE MANAGEMENT**
...
1. **THE 8-STAGE INTERVIEW WORKFLOW**
...
1. **STORY FOUNDATION DOCUMENT SPECIFICATION (OUTPUT FORMAT)**
...
1. **Story Format:** [Primary Format, Supporting Formats, brief diagnostic reasons]
2. **Premise:** (1-2 paragraph overview of protagonist, conflict, situation, stakes)
3. **Logline:** (1 paragraph containing protagonist, goal, obstacle, stakes, tone)
4. **Genre & Tone Specification:** [Genre, Subgenre, Tone, Style, Audience, Scale]
5. **Thematic Blueprint:**
...
1. **Dramatic Engine:** [Protagonist (1 sentence), Antagonistic Force (1 sentence), Central Conflict (1 paragraph), Primary Stakes (1 paragraph), Transformation Arc (1 paragraph), Emotional Journey]
2. **Principal Characters:** (List main characters. Include: Name, Story Role, 1-sentence description, Primary Story Function. No bios/psych details.)
3. **World Foundation:** [Time Period, Primary Settings, Nature of the World, Premise Assumptions, Crucial Environmental Rules]
4. **Story Spine:** [Opening Image, Inciting Incident, First Turning Point, Midpoint, Second Turning Point, Climax, Closing Image - Max 2 sentences each]
5. **Outstanding Questions:** (Document all unresolved/Parked items for future projects)
6. **Version History:** [Table tracking Version, Date, Summary of Changes]
